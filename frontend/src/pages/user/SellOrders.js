...
const SellOrders = (props) => {
    ...
    return <div className="container-fluid">
            ...
            <div className="col-md-9"> 
                <h4 className={'alert alert-secondary'}>Sell Orders</h4>
            {/* cols */}
            <div className={"row"}>
            {orders ? orders.map(ord => (<div className="col-md-5 col-lg-5 col-sm-12 ml-1 p-0"><div
                ...
                <button className="col-lg-12 btn btn-outline-info">Have you Delivered?</button>
