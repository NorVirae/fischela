...
import { listFarmQuery } from "../../constants/schemas"
...
const AllFarmsComp = () => {
    ...
    const {loading, data, error} = useQuery(listFarmQuery)

    return( <section className="farms">
